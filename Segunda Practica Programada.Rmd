...
Datos_AQI_Quality_Excel <- list("Bueno" = Good <-datos_airquality |> 
    ...
    "Insalubre"= Unhealthy <- datos_airquality |> 
     ...
     "No saludable" = No_saludable <- datos_airquality |> 
      filter(`AQI Category` == "No_saludable"),
    "Muy insalubre" = Muy_insalubre <- datos_airquality|> 
      filter(`AQI Category` == "Muy_insalubre"),
    "No_saludable_sensibles" = No_saludable_sensibles <- datos_airquality |> 
      filter(`AQI Category` == "No_saludable_sensibles"))

write_xlsx(datos_categoria_AQI_excel,path = "Datos/Datos_AQI_Quality_Excel.xlsx")
```
